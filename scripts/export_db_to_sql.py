...
def export_database():
    ...
    with open(OUTPUT_PATH, 'w', encoding='utf-8') as f:
        ...
        f.write("""CREATE TABLE IF NOT EXISTS players (
...
""")
        ...
        f.write("""CREATE TABLE IF NOT EXISTS user_collections (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
...
""")
        ...
        f.write("""CREATE TABLE IF NOT EXISTS server_configs (
...
""")
        ...
        f.write("""CREATE TABLE IF NOT EXISTS leaderboard_snapshots (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    user_id INTEGER NOT NULL,
    server_id INTEGER NOT NULL,
...
""")
        ...
        f.write("CREATE INDEX IF NOT EXISTS idx_user_collections_user_id ON user_collections(user_id);\n")
        f.write("CREATE INDEX IF NOT EXISTS idx_user_collections_server_id ON user_collections(server_id);\n")
        f.write("CREATE INDEX IF NOT EXISTS idx_leaderboard_period ON leaderboard_snapshots(period, server_id);\n")
        ...
        cursor.execute("SELECT id, name, adp_value, rarity_tier, image_url, career_minutes, created_at FROM players ORDER BY id")
        ...
        for player in players:
            ...
            f.write(f"INSERT INTO players (id, name, adp_value, rarity_tier, image_url, career_minutes, created_at) ")
            f.write(f"VALUES ({player_id}, '{name_escaped}', {adp_val}, '{rarity_tier}', {image_val}, {minutes_val}, {time_val});\n")
